...
#define SWIG_init    Alchemify_Init
#define SWIG_name    "alchemify"
#define SWIG_prefix  ""
...
#endif
SWIGINTERN int
_wrap_alchemify(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  char *arg1 = (char *) 0 ;
  char *arg2 = (char *) 0 ;
  char *arg3 = (char *) 0 ;
  int result;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"ooo:alchemify inPSF outPSF inFEP ",(void *)0,(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_AsCharPtrAndSize(objv[1], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "alchemify" "', argument " "1"" of type '" "char *""'");
  }
  arg1 = (char *)(buf1);
  res2 = SWIG_AsCharPtrAndSize(objv[2], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "alchemify" "', argument " "2"" of type '" "char *""'");
  }
  arg2 = (char *)(buf2);
  res3 = SWIG_AsCharPtrAndSize(objv[3], &buf3, NULL, &alloc3);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "alchemify" "', argument " "3"" of type '" "char *""'");
  }
  arg3 = (char *)(buf3);
  result = (int)alchemify(arg1,arg2,arg3);
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "alchemify", (swig_wrapper_func) _wrap_alchemify, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Alchemify_SafeInit(Tcl_Interp *interp) {
