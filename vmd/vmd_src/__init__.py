...
# Load the library
vmd = imp.load_dynamic(__name__, str(vmdlib))
...
vmd.Molecule = imp.load_source(
    "Molecule", os.path.join(os.environ["VMDDIR"], "Molecule.py")
)
vmd.Label = imp.load_source("Label", os.path.join(os.environ["VMDDIR"], "Label.py"))
vmd.Material = imp.load_source(
